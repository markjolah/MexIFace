...
cmake -H. -B$BUILD_PATH -DOPT_COPY_SYSTEM_LIBS=1 -DCMAKE_TOOLCHAIN_FILE="$TOOLCHAIN_FILE" -DCMAKE_INSTALL_PREFIX="$INSTALL_PATH" -DCMAKE_BUILD_TYPE=Debug -DBUILD_TESTING=1
