...
# MexIFace_MATLAB_INCOMPATIBLE_ROOTS
# MexIFace_MATLAB_INCOMPATIBLE_VERSIONS
# MexIFace_MATLAB_INCOMPATIBLE_RELEASES
# MexIFace_MATLAB_INCOMPATIBLE_ARCHS
# MexIFace_MATLAB_INCOMPATIBLE_LIBSTDCXX_VERSIONS
# MexIFace_MATLAB_INCOMPATIBLE_REASONS
#
...
function(_mexiface_get_matlab_roots roots)
    ...
    set(MexIFace_MATLAB_INCOMPATIBLE_ROOTS ${_invalid_roots} PARENT_SCOPE)
    set(MexIFace_MATLAB_INCOMPATIBLE_VERSIONS ${_invalid_versions} PARENT_SCOPE)
    set(MexIFace_MATLAB_INCOMPATIBLE_RELEASES ${_invalid_releases} PARENT_SCOPE)
    set(MexIFace_MATLAB_INCOMPATIBLE_ARCHS ${_invalid_archs} PARENT_SCOPE)
    set(MexIFace_MATLAB_INCOMPATIBLE_LIBSTDCXX_VERSIONS ${_invalid_libstdcxxs} PARENT_SCOPE)
    set(MexIFace_MATLAB_INCOMPATIBLE_REASONS ${_invalid_reasons} PARENT_SCOPE)
endfunction()
    ...
    if(niter GREATER_EQUAL 0)
        foreach(idx RANGE ${niter})
            ...
            if(OPT_MexIFace_MATLAB_INTERLEAVED_COMPLEX AND ${_vers} VERSION_GREATER_EQUAL 9.4)
                set_property(TARGET ${target_prefix}MEX_LIBRARIES APPEND PROPERTY INTERFACE_COMPILE_DEFINITIONS MATLAB_DEFAULT_RELEASE=R2018a)
            else()
                set_property(TARGET ${target_prefix}MEX_LIBRARIES APPEND PROPERTY INTERFACE_COMPILE_DEFINITIONS MATLAB_DEFAULT_RELEASE=R2017b)
            endif()
            #Support for 64-bit indexed arrays enabled for all Matlab versions
            if(OPT_MexIFace_MATLAB_LARGE_ARRAY_DIMS)
                set_property(TARGET ${target_prefix}MEX_LIBRARIES APPEND PROPERTY INTERFACE_COMPILE_DEFINITIONS MX_COMPAT_64)
            else()
                set_property(TARGET ${target_prefix}MEX_LIBRARIES APPEND PROPERTY INTERFACE_COMPILE_DEFINITIONS MX_COMPAT_32)
            endif()
...
if(MATLAB_ROOT)
    get_filename_component(MATLAB_ROOT ${MATLAB_ROOT} ABSOLUTE)
...
if(NOT MATLAB_ROOTS) #Look in environment VARIABLES
    if(NOT WIN32)
        ...
        if(ENV_MATLAB_ROOT)
            string(REPLACE ":" ";" ENV_MATLAB_ROOT "${ENV_MATLAB_ROOT}")
            list(APPEND MATLAB_ROOTS ${ENV_MATLAB_ROOT})
        endif()
        set(ENV_MATLAB_ROOTS "$ENV{MATLAB_ROOTS}")
        if(ENV_MATLAB_ROOTS)
            string(REPLACE ":" ";" ENV_MATLAB_ROOTS "${ENV_MATLAB_ROOTS}")
    ...
    set(_new_roots)
    foreach(_root IN LISTS MATLAB_ROOTS)
        get_filename_component(_root ${_root} ABSOLUTE)
        list(APPEND _new_roots ${_root})
    endforeach()
    set(MATLAB_ROOTS ${_new_roots})
endif()
if(NOT MATLAB_ROOTS)
...
if(NOT MexIFace_MATLAB_FOUND OR NOT MexIFace_MATLAB_SEARCH_ROOTS OR NOT MATLAB_ROOTS STREQUAL MexIFace_MATLAB_SEARCH_ROOTS)
    ...
    set(MexIFace_MATLAB_INCOMPATIBLE_ROOTS ${MexIFace_MATLAB_INCOMPATIBLE_ROOTS} CACHE INTERNAL "Invalid matlab roots")
    set(MexIFace_MATLAB_INCOMPATIBLE_VERSIONS ${MexIFace_MATLAB_INCOMPATIBLE_VERSIONS} CACHE INTERNAL "Invalid matlab versions as X.Y")
    set(MexIFace_MATLAB_INCOMPATIBLE_VERSION_STRINGS ${MexIFace_MATLAB_INCOMPATIBLE_VERSION_STRINGS} CACHE INTERNAL "Invalid matlab versions as X_Y")
    set(MexIFace_MATLAB_INCOMPATIBLE_RELEASES ${MexIFace_MATLAB_INCOMPATIBLE_RELEASES} CACHE INTERNAL "Invalid matlab releases")
    set(MexIFace_MATLAB_INCOMPATIBLE_LIBSTDCXX_VERSIONS ${MexIFace_MATLAB_INCOMPATIBLE_LIBSTDCXX_VERSIONS} CACHE INTERNAL "Invalid matlab libstdc++.so versions")
    set(MexIFace_MATLAB_INCOMPATIBLE_REASONS ${MexIFace_MATLAB_INCOMPATIBLE_REASONS} CACHE INTERNAL "Invalid matlab releasons for invalidity")
    mark_as_advanced(MexIFace_MATLAB_ROOTS MexIFace_MATLAB_VERSIONS MexIFace_MATLAB_VERSION_STRINGS MexIFace_MATLAB_RELEASES MexIFace_MATLAB_LIBSTDCXX_VERSIONS
                     MexIFace_MATLAB_INCOMPATIBLE_ROOTS MexIFace_MATLAB_INCOMPATIBLE_VERSIONS MexIFace_MATLAB_INCOMPATIBLE_VERSION_STRINGS MexIFace_MATLAB_INCOMPATIBLE_RELEASES
                     MexIFace_MATLAB_INCOMPATIBLE_LIBSTDCXX_VERSIONS MexIFace_MATLAB_INCOMPATIBLE_REASONS)
endif()
...
if(NOT OPT_MexIFace_SILENT)
    ...
    message(STATUS "[MexIFace::Matlab] MexIFace_MATLAB_INCOMPATIBLE_ROOTS:${MexIFace_MATLAB_INCOMPATIBLE_ROOTS}")
    message(STATUS "[MexIFace::Matlab] MexIFace_MATLAB_INCOMPATIBLE_VERSIONS:${MexIFace_MATLAB_INCOMPATIBLE_VERSIONS}")
    message(STATUS "[MexIFace::Matlab] MexIFace_MATLAB_INCOMPATIBLE_RELEASES:${MexIFace_MATLAB_INCOMPATIBLE_RELEASES}")
    message(STATUS "[MexIFace::Matlab] MexIFace_MATLAB_INCOMPATIBLE_ARCHS:${MexIFace_MATLAB_INCOMPATIBLE_ARCHS}")
    message(STATUS "[MexIFace::Matlab] MexIFace_MATLAB_INCOMPATIBLE_LIBSTDCXX_VERSIONS:${MexIFace_MATLAB_INCOMPATIBLE_LIBSTDCXX_VERSIONS}")
    message(STATUS "[MexIFace::Matlab] MexIFace_MATLAB_INCOMPATIBLE_REASONS:${MexIFace_MATLAB_INCOMPATIBLE_REASONS}")
...
if(OPT_MexIFace_VERBOSE)
    ...
    set(_Print_Properties TYPE IMPORTED_CONFIGURATIONS INTERFACE_INCLUDE_DIRECTORIES INTERFACE_LINK_LIBRARIES INTERFACE_LINK_DIRECTORIES INTERFACE_COMPILE_FEATURES INTERFACE_COMPILE_DEFINITIONS INTERFACE_COMPILE_OPTIONS)
