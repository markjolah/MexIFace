...
function(_mexiface_make_matlab_targets)
    ...
    if(niter GREATER_EQUAL 0)
        foreach(idx RANGE ${niter})
            ...
            target_link_directories(${target_prefix}MEX_LIBRARIES INTERFACE ${lib_dir} ${extern_lib_dir})
...
if(NOT MATLAB_ROOTS) #Look in environment VARIABLES
    if(NOT CMAKE_CROSSCOMPILING OR UNIX)
...
message(STATUS "[MexIFace::Matlab] MATLAB_ROOTS:'${MATLAB_ROOTS}' MexIFace_MATLAB_FOUND:${MexIFace_MATLAB_FOUND} MexIFace_MATLAB_ORIGINAL_ROOTS:${MexIFace_MATLAB_ORIGINAL_ROOTS} ")
